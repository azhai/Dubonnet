...
namespace Dubonnet.Resolvers
{
        ...
        public class DefaultPropertyResolver : IPropertyResolver
        {
            ...
            /// <returns>A collection of <see cref="DubonProperty"/>'s of the <paramref name="type"/>.</returns>
            public virtual IEnumerable<DubonProperty> Resolve(Type type) => FilterComplexTypes(type);

            /// <summary>
            /// Gets a collection of types that are considered 'primitive' for Dubon but are not for the CLR.
            ...
            protected virtual IEnumerable<DubonProperty> FilterComplexTypes(Type type)
            {

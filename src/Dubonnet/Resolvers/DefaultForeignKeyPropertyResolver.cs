...
namespace Dubonnet.Resolvers
{
        ...
        public class DefaultForeignKeyPropertyResolver : IForeignKeyPropertyResolver
        {
            ...
            public virtual DubonProperty Resolve(Type sourceType, Type includingType, out ForeignKeyRelation foreignKeyRelation)
            {
            ...
            private static DubonProperty ResolveOneToOne(Type sourceType, Type includingType)
            {
                ...
                {
                    return new DubonProperty(sourceType, foreignKeyProperty);
                }
                ...
                if (navigationProperty != null)
                {
                    ...
                    if (fkAttr != null)
                    {
                        return new DubonProperty(sourceType, sourceType.GetProperty(fkAttr.Name));
                    }
                }
            ...
            private static DubonProperty ResolveOneToMany(Type sourceType, Type includingType)
            {
                ...
                if (foreignKeyProperty != null)
                {
                    return new DubonProperty(includingType,foreignKeyProperty);
                }
                ...
                if (navigationProperty != null)
                {
                    ...
                    if (fkAttr != null)
                    {
                        return new DubonProperty(includingType,includingType.GetProperty(fkAttr.Name));
                    }
                }

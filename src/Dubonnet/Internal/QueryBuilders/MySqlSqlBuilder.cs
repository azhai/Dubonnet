...
namespace Dubonnet.Internal.QueryBuilders
{

    /// <summary>
    ///   <see cref="T:Dubonnet.ISqlBuilder" /> implementation for MySQL.
    /// </summary>
    ...
    public sealed class MySqlSqlBuilder : ISqlBuilder
    {
        ...
        /// </returns>
        /// <inheritdoc />
        public string BuildInsert(string tableName, string[] columnNames, string[] paramNames, DubonProperty keyProperty)
        {
            if (DubonMapper.EscapeCharacterStart == char.MinValue && DubonMapper.EscapeCharacterEnd == char.MinValue)
            {

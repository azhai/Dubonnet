...
{
    public abstract partial class Compiler<Q> where Q : QueryFactory<Q>
    {
        private readonly ISqlResultBinder<Q> _sqlResultBinder;
        private readonly ConditionProvider<Q> _compileConditionMethodsProvider;

        protected Compiler(ISqlResultBinder<Q> sqlResultBinder)
        {
            _sqlResultBinder = sqlResultBinder;
            _compileConditionMethodsProvider = new ConditionProvider<Q>(this);
        }
        ...
        protected virtual SqlResult<Q> CompileRaw(Q factory)
        {
            SqlResult<Q> ctx;

            if (factory.Method == "insert")
            {
                ctx = CompileInsertQuery(factory);
            }
            else if (factory.Method == "update")
            {
                ctx = CompileUpdateQuery(factory);
            }
            else if (factory.Method == "delete")
            {
                ctx = CompileDeleteQuery(factory);
            }
            else
            {
                if (factory.Method == "aggregate")
                {
                    factory.ClearComponent("limit")
                        .ClearComponent("order")
                        .ClearComponent("group");
                }

                ctx = CompileSelectQuery(factory);
            }

            // handle CTEs
            if (factory.HasComponent("cte", EngineCode))
            {
                var cteFinder = new CteFinder<Q>(factory, EngineCode);
        ...
        public virtual SqlResult<Q> Compile(string sql, params object[] args)
        {
            var ctx = new SqlResult<Q>();
            ctx.Bindings = args.ToList();
            ctx.RawSql = sql;
            _sqlResultBinder.BindNamedParameters(ctx);
            return ctx;
        }
        
        public virtual SqlResult<Q> Compile(Q factory)
        {
            var ctx = CompileRaw(factory);
            _sqlResultBinder.BindNamedParameters(ctx);
            return ctx;
        }

        public virtual SqlResult<Q> Compile(IEnumerable<Q> queries)
        {
        ...
        protected virtual SqlResult<Q> CompileSelectQuery(Q factory)
        {
            var ctx = new SqlResult<Q>
            {
        ...
        private SqlResult<Q> CompileDeleteQuery(Q factory)
        {
            var ctx = new SqlResult<Q>
            {
                Query = factory
        ...
        private SqlResult<Q> CompileUpdateQuery(Q factory)
        {
            var ctx = new SqlResult<Q>
            {
                Query = factory
        ...
        protected virtual SqlResult<Q> CompileInsertQuery(Q factory)
        {
            var ctx = new SqlResult<Q>
            {
                Query = factory
            ...
            {
                var clause = inserts[0] as InsertQueryClause<Q>;
        ...
        /// <returns></returns>
        public virtual string CompileColumn(SqlResult<Q> ctx, AbstractColumn column)
        {
            ...
            if (column is QueryColumn<Q> queryColumn)
            {
                var alias = "";
        ...
        protected virtual SqlResult<Q> OnBeforeCompile(SqlResult<Q> ctx)
        {
            return ctx;
        }
        ...
        public virtual SqlResult<Q> CompileCte(AbstractFrom cte)
        {
            var ctx = new SqlResult<Q>();
            ...
            else if (cte is QueryFromClause<Q> queryFromClause)
            {
        ...
        protected virtual SqlResult<Q> OnBeforeSelect(SqlResult<Q> ctx)
        {
            return ctx;
        }

        protected virtual string CompileColumns(SqlResult<Q> ctx)
        {
        ...
        public virtual string CompileUnion(SqlResult<Q> ctx)
        {
        ...
        public virtual string CompileTableExpression(SqlResult<Q> ctx, AbstractFrom from)
        {
            ...
            if (from is QueryFromClause<Q> queryFromClause)
            {
        ...
        public virtual string CompileFrom(SqlResult<Q> ctx)
        {
            if (!ctx.Query.HasComponent("from", EngineCode))
            {
        ...
        public virtual string CompileJoins(SqlResult<Q> ctx)
        {
            ...
            var joins = ctx.Query
                .GetComponents<BaseJoin<Q>>("join", EngineCode)
        ...
        public virtual string CompileWheres(SqlResult<Q> ctx)
        {
        ...
        public virtual string CompileGroups(SqlResult<Q> ctx)
        {
        ...
        public virtual string CompileOrders(SqlResult<Q> ctx)
        {
        ...
        public string CompileHaving(SqlResult<Q> ctx)
        {
        ...
        public virtual string CompileLimit(SqlResult<Q> ctx)
        {
        ...
        // public virtual string CompileOffset(SqlResult<Q> ctx)
        // {
        ...
        public virtual string Parameter<T>(SqlResult<Q> ctx, T value)
        {
        ...
        /// <summary>
        /// Create factory parameter place-holders for an array.
        /// </summary>
        /// <param name="ctx"></param>
        /// <param name="values"></param>
        /// <returns></returns>
        public virtual string Parameterize<T>(SqlResult<Q> ctx, IEnumerable<T> values)
        {

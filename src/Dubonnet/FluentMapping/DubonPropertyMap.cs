...
{
    /// <summary>
    /// Represents mapping of a property for Dubon.
    /// </summary>
    /// <seealso>
    ///     <cref>Dapper.FluentMap.Mapping.PropertyMapBase{Dubonnet.FluentMapping.DubonPropertyMap}</cref>
    /// </seealso>
    ...
    /// </inheritdoc>
    public class DubonPropertyMap : PropertyMapBase<DubonPropertyMap>, IPropertyMap
    {
        /// <inheritdoc />
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Dubonnet.FluentMapping.DubonPropertyMap" /> class
        ...
        public DubonPropertyMap(PropertyInfo info) : base(info)
        {
        }
        ...
        /// </summary>
        /// <returns>
        /// The current instance of <see cref="DubonPropertyMap" />.
        /// </returns>
        public DubonPropertyMap IsKey()
        {
            Key = true;
            return this;
        }
        ...
        /// The current instance of <see cref="DubonPropertyMap" />.
        /// </returns>
        public DubonPropertyMap IsIdentity()
        {
            Identity = true;
            return this;
        }
